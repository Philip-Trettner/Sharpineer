...
namespace User32Dll
{
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool AppendMenu([MarshalAs(UnmanagedType.Struct)] HMENU /* HMENU */ @hMenu,  uint /* UINT */ @uFlags,  ulong /* UINT_PTR */ @uIDNewItem,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpNewItem);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int BroadcastSystemMessage( uint /* DWORD */ @flags,  ref IntPtr /* unsigned long *, LPDWORD */ @lpInfo,  uint /* UINT */ @Msg,  ulong /* WPARAM */ @wParam,  long /* LPARAM */ @lParam);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int BroadcastSystemMessageEx( uint /* DWORD */ @flags,  ref IntPtr /* unsigned long *, LPDWORD */ @lpInfo,  uint /* UINT */ @Msg,  ulong /* WPARAM */ @wParam,  long /* LPARAM */ @lParam, [MarshalAs(UnmanagedType.LPStruct)] ref BSMINFO /* PBSMINFO */ @pbsmInfo);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern long /* LRESULT */ CallWindowProc( ref IntPtr /* long long (*)(HWND__ *, unsigned int, unsigned long long, long long), WNDPROC */ @lpPrevWndFunc, [MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWnd,  uint /* UINT */ @Msg,  ulong /* WPARAM */ @wParam,  long /* LPARAM */ @lParam);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern ushort /* WORD */ CascadeWindows([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hwndParent,  uint /* UINT */ @wHow, [MarshalAs(UnmanagedType.LPStruct)] ref RECT /* const RECT * */ @lpRect,  uint /* UINT */ @cKids,  ref IntPtr /* HWND__ *const *, const HWND * */ @lpKids);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int /* LONG */ ChangeDisplaySettingsEx( ref IntPtr /* const wchar_t *, LPCWSTR */ @lpszDeviceName, [MarshalAs(UnmanagedType.LPStruct)] ref devicemodeW /* DEVMODEW * */ @lpDevMode, [MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hwnd,  uint /* DWORD */ @dwflags,  ref IntPtr /* void *, LPVOID */ @lParam);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool ChangeMenu([MarshalAs(UnmanagedType.Struct)] HMENU /* HMENU */ @hMenu,  uint /* UINT */ @cmd,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpszNewItem,  uint /* UINT */ @cmdInsert,  uint /* UINT */ @flags);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern string /* wchar_t *, LPWSTR */ CharLower([MarshalAs(UnmanagedType.LPWStr)] ref string /* wchar_t *, LPWSTR */ @lpsz);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern uint /* DWORD */ CharLowerBuff([MarshalAs(UnmanagedType.LPWStr)] ref string /* wchar_t *, LPWSTR */ @lpsz,  uint /* DWORD */ @cchLength);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern string /* wchar_t *, LPWSTR */ CharNext( ref IntPtr /* const wchar_t *, LPCWSTR */ @lpsz);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern string /* char *, LPSTR */ CharNextExA( ushort /* WORD */ @CodePage,  ref IntPtr /* const char *, LPCSTR */ @lpCurrentChar,  uint /* DWORD */ @dwFlags);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern string /* wchar_t *, LPWSTR */ CharPrev( ref IntPtr /* const wchar_t *, LPCWSTR */ @lpszStart,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpszCurrent);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern string /* char *, LPSTR */ CharPrevExA( ushort /* WORD */ @CodePage,  ref IntPtr /* const char *, LPCSTR */ @lpStart,  ref IntPtr /* const char *, LPCSTR */ @lpCurrentChar,  uint /* DWORD */ @dwFlags);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool CharToOem( ref IntPtr /* const wchar_t *, LPCWSTR */ @pSrc, [MarshalAs(UnmanagedType.LPTStr)] ref string /* char *, LPSTR */ @pDst);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool CharToOemBuff( ref IntPtr /* const wchar_t *, LPCWSTR */ @lpszSrc, [MarshalAs(UnmanagedType.LPTStr)] ref string /* char *, LPSTR */ @lpszDst,  uint /* DWORD */ @cchDstLength);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern string /* wchar_t *, LPWSTR */ CharUpper([MarshalAs(UnmanagedType.LPWStr)] ref string /* wchar_t *, LPWSTR */ @lpsz);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern uint /* DWORD */ CharUpperBuff([MarshalAs(UnmanagedType.LPWStr)] ref string /* wchar_t *, LPWSTR */ @lpsz,  uint /* DWORD */ @cchLength);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern IntPtr /* void *, HANDLE */ CopyImage( ref IntPtr /* void *, HANDLE */ @h,  uint /* UINT */ @type,  int @cx,  int @cy,  uint /* UINT */ @flags);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HICON /* HCURSOR */ CreateCursor([MarshalAs(UnmanagedType.Struct)] HINSTANCE /* HINSTANCE */ @hInst,  int @xHotSpot,  int @yHotSpot,  int @nWidth,  int @nHeight,  ref IntPtr /* const void *, const void * */ @pvANDPlane,  ref IntPtr /* const void *, const void * */ @pvXORPlane);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HDESK /* HDESK */ CreateDesktop( ref IntPtr /* const wchar_t *, LPCWSTR */ @lpszDesktop,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpszDevice, [MarshalAs(UnmanagedType.LPStruct)] ref devicemodeW /* DEVMODEW * */ @pDevmode,  uint /* DWORD */ @dwFlags,  uint /* ACCESS_MASK */ @dwDesiredAccess, [MarshalAs(UnmanagedType.LPStruct)] ref SECURITY_ATTRIBUTES /* LPSECURITY_ATTRIBUTES */ @lpsa);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HDESK /* HDESK */ CreateDesktopEx( ref IntPtr /* const wchar_t *, LPCWSTR */ @lpszDesktop,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpszDevice, [MarshalAs(UnmanagedType.LPStruct)] ref devicemodeW /* DEVMODEW * */ @pDevmode,  uint /* DWORD */ @dwFlags,  uint /* ACCESS_MASK */ @dwDesiredAccess, [MarshalAs(UnmanagedType.LPStruct)] ref SECURITY_ATTRIBUTES /* LPSECURITY_ATTRIBUTES */ @lpsa,  uint /* ULONG */ @ulHeapSize,  ref IntPtr /* void *, PVOID */ @pvoid);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HWND /* HWND */ CreateDialogIndirectParam([MarshalAs(UnmanagedType.Struct)] HINSTANCE /* HINSTANCE */ @hInstance, [MarshalAs(UnmanagedType.LPStruct)] ref DLGTEMPLATE /* LPCDLGTEMPLATEW */ @lpTemplate, [MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWndParent,  ref IntPtr /* long long (*)(HWND__ *, unsigned int, unsigned long long, long long), DLGPROC */ @lpDialogFunc,  long /* LPARAM */ @dwInitParam);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HWND /* HWND */ CreateDialogParam([MarshalAs(UnmanagedType.Struct)] HINSTANCE /* HINSTANCE */ @hInstance,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpTemplateName, [MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWndParent,  ref IntPtr /* long long (*)(HWND__ *, unsigned int, unsigned long long, long long), DLGPROC */ @lpDialogFunc,  long /* LPARAM */ @dwInitParam);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HICON /* HICON */ CreateIcon([MarshalAs(UnmanagedType.Struct)] HINSTANCE /* HINSTANCE */ @hInstance,  int @nWidth,  int @nHeight,  byte @cPlanes,  byte @cBitsPixel,  ref IntPtr /* const unsigned char *, const BYTE * */ @lpbANDbits,  ref IntPtr /* const unsigned char *, const BYTE * */ @lpbXORbits);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HICON /* HICON */ CreateIconFromResource( ref IntPtr /* unsigned char *, PBYTE */ @presbits,  uint /* DWORD */ @dwResSize,  bool @fIcon,  uint /* DWORD */ @dwVer);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HICON /* HICON */ CreateIconFromResourceEx( ref IntPtr /* unsigned char *, PBYTE */ @presbits,  uint /* DWORD */ @dwResSize,  bool @fIcon,  uint /* DWORD */ @dwVer,  int @cxDesired,  int @cyDesired,  uint /* UINT */ @Flags);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HICON /* HICON */ CreateIconIndirect([MarshalAs(UnmanagedType.LPStruct)] ref ICONINFO /* PICONINFO */ @piconinfo);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HWND /* HWND */ CreateMDIWindow( ref IntPtr /* const wchar_t *, LPCWSTR */ @lpClassName,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpWindowName,  uint /* DWORD */ @dwStyle,  int @X,  int @Y,  int @nWidth,  int @nHeight, [MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWndParent, [MarshalAs(UnmanagedType.Struct)] HINSTANCE /* HINSTANCE */ @hInstance,  long /* LPARAM */ @lParam);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HWND /* HWND */ CreateWindowEx( uint /* DWORD */ @dwExStyle,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpClassName,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpWindowName,  uint /* DWORD */ @dwStyle,  int @X,  int @Y,  int @nWidth,  int @nHeight, [MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWndParent, [MarshalAs(UnmanagedType.Struct)] HMENU /* HMENU */ @hMenu, [MarshalAs(UnmanagedType.Struct)] HINSTANCE /* HINSTANCE */ @hInstance,  ref IntPtr /* void *, LPVOID */ @lpParam);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HWINSTA /* HWINSTA */ CreateWindowStation( ref IntPtr /* const wchar_t *, LPCWSTR */ @lpwinsta,  uint /* DWORD */ @dwFlags,  uint /* ACCESS_MASK */ @dwDesiredAccess, [MarshalAs(UnmanagedType.LPStruct)] ref SECURITY_ATTRIBUTES /* LPSECURITY_ATTRIBUTES */ @lpsa);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern IntPtr /* unsigned char *, LPBYTE */ DdeAccessData([MarshalAs(UnmanagedType.Struct)] HDDEDATA /* HDDEDATA */ @hData,  ref IntPtr /* unsigned long *, LPDWORD */ @pcbDataSize);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HDDEDATA /* HDDEDATA */ DdeAddData([MarshalAs(UnmanagedType.Struct)] HDDEDATA /* HDDEDATA */ @hData,  ref IntPtr /* unsigned char *, LPBYTE */ @pSrc,  uint /* DWORD */ @cb,  uint /* DWORD */ @cbOff);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HDDEDATA /* HDDEDATA */ DdeClientTransaction( ref IntPtr /* unsigned char *, LPBYTE */ @pData,  uint /* DWORD */ @cbData, [MarshalAs(UnmanagedType.Struct)] HCONV /* HCONV */ @hConv, [MarshalAs(UnmanagedType.Struct)] HSZ /* HSZ */ @hszItem,  uint /* UINT */ @wFmt,  uint /* UINT */ @wType,  uint /* DWORD */ @dwTimeout,  ref IntPtr /* unsigned long *, LPDWORD */ @pdwResult);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HDDEDATA /* HDDEDATA */ DdeCreateDataHandle( uint /* DWORD */ @idInst,  ref IntPtr /* unsigned char *, LPBYTE */ @pSrc,  uint /* DWORD */ @cb,  uint /* DWORD */ @cbOff, [MarshalAs(UnmanagedType.Struct)] HSZ /* HSZ */ @hszItem,  uint /* UINT */ @wFmt,  uint /* UINT */ @afCmd);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HSZ /* HSZ */ DdeCreateStringHandle( uint /* DWORD */ @idInst,  ref IntPtr /* const wchar_t *, LPCWSTR */ @psz,  int @iCodePage);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern uint /* DWORD */ DdeGetData([MarshalAs(UnmanagedType.Struct)] HDDEDATA /* HDDEDATA */ @hData,  ref IntPtr /* unsigned char *, LPBYTE */ @pDst,  uint /* DWORD */ @cbMax,  uint /* DWORD */ @cbOff);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern uint /* UINT */ DdeInitialize( ref IntPtr /* unsigned long *, LPDWORD */ @pidInst,  ref IntPtr /* HDDEDATA__ *(*)(unsigned int, unsigned int, HCONV__ *, HSZ__ *, HSZ__ *, HDDEDATA__ *, unsigned long long, unsigned long long), PFNCALLBACK */ @pfnCallback,  uint /* DWORD */ @afCmd,  uint /* DWORD */ @ulRes);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern uint /* DWORD */ DdeQueryString( uint /* DWORD */ @idInst, [MarshalAs(UnmanagedType.Struct)] HSZ /* HSZ */ @hsz, [MarshalAs(UnmanagedType.LPWStr)] ref string /* wchar_t *, LPWSTR */ @psz,  uint /* DWORD */ @cchMax,  int @iCodePage);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern IntPtr /* void *, HDWP */ DeferWindowPos( ref IntPtr /* void *, HDWP */ @hWinPosInfo, [MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWnd, [MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWndInsertAfter,  int @x,  int @y,  int @cx,  int @cy,  uint /* UINT */ @uFlags);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern long /* LRESULT */ DefRawInputProc( ref IntPtr /* tagRAWINPUT **, PRAWINPUT * */ @paRawInput,  int /* INT */ @nInput,  uint /* UINT */ @cbSizeHeader);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int DlgDirList([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hDlg, [MarshalAs(UnmanagedType.LPWStr)] ref string /* wchar_t *, LPWSTR */ @lpPathSpec,  int @nIDListBox,  int @nIDStaticPath,  uint /* UINT */ @uFileType);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int DlgDirListComboBox([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hDlg, [MarshalAs(UnmanagedType.LPWStr)] ref string /* wchar_t *, LPWSTR */ @lpPathSpec,  int @nIDComboBox,  int @nIDStaticPath,  uint /* UINT */ @uFiletype);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool DlgDirSelectComboBoxEx([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hwndDlg, [MarshalAs(UnmanagedType.LPWStr)] ref string /* wchar_t *, LPWSTR */ @lpString,  int @cchOut,  int @idComboBox);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool DlgDirSelectEx([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hwndDlg, [MarshalAs(UnmanagedType.LPWStr)] ref string /* wchar_t *, LPWSTR */ @lpString,  int @chCount,  int @idListBox);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool DrawState([MarshalAs(UnmanagedType.Struct)] HDC /* HDC */ @hdc, [MarshalAs(UnmanagedType.Struct)] HBRUSH /* HBRUSH */ @hbrFore,  ref IntPtr /* int (*)(HDC__ *, long long, unsigned long long, int, int), DRAWSTATEPROC */ @qfnCallBack,  long /* LPARAM */ @lData,  ulong /* WPARAM */ @wData,  int @x,  int @y,  int @cx,  int @cy,  uint /* UINT */ @uFlags);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int DrawText([MarshalAs(UnmanagedType.Struct)] HDC /* HDC */ @hdc,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpchText,  int @cchText, [MarshalAs(UnmanagedType.LPStruct)] ref RECT /* LPRECT */ @lprc,  uint /* UINT */ @format);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int DrawTextEx([MarshalAs(UnmanagedType.Struct)] HDC /* HDC */ @hdc, [MarshalAs(UnmanagedType.LPWStr)] ref string /* wchar_t *, LPWSTR */ @lpchText,  int @cchText, [MarshalAs(UnmanagedType.LPStruct)] ref RECT /* LPRECT */ @lprc,  uint /* UINT */ @format, [MarshalAs(UnmanagedType.LPStruct)] ref DRAWTEXTPARAMS /* LPDRAWTEXTPARAMS */ @lpdtp);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool EndDeferWindowPos( ref IntPtr /* void *, HDWP */ @hWinPosInfo);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool EnumChildWindows([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWndParent,  ref IntPtr /* int (*)(HWND__ *, long long), WNDENUMPROC */ @lpEnumFunc,  long /* LPARAM */ @lParam);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool EnumDesktops([MarshalAs(UnmanagedType.Struct)] HWINSTA /* HWINSTA */ @hwinsta,  ref IntPtr /* int (*)(wchar_t *, long long), DESKTOPENUMPROCW */ @lpEnumFunc,  long /* LPARAM */ @lParam);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool EnumDesktopWindows([MarshalAs(UnmanagedType.Struct)] HDESK /* HDESK */ @hDesktop,  ref IntPtr /* int (*)(HWND__ *, long long), WNDENUMPROC */ @lpfn,  long /* LPARAM */ @lParam);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool EnumDisplayDevices( ref IntPtr /* const wchar_t *, LPCWSTR */ @lpDevice,  uint /* DWORD */ @iDevNum, [MarshalAs(UnmanagedType.LPStruct)] ref DISPLAY_DEVICEW /* PDISPLAY_DEVICEW */ @lpDisplayDevice,  uint /* DWORD */ @dwFlags);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool EnumDisplayMonitors([MarshalAs(UnmanagedType.Struct)] HDC /* HDC */ @hdc, [MarshalAs(UnmanagedType.LPStruct)] ref RECT /* LPCRECT */ @lprcClip,  ref IntPtr /* int (*)(HMONITOR__ *, HDC__ *, tagRECT *, long long), MONITORENUMPROC */ @lpfnEnum,  long /* LPARAM */ @dwData);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool EnumDisplaySettings( ref IntPtr /* const wchar_t *, LPCWSTR */ @lpszDeviceName,  uint /* DWORD */ @iModeNum, [MarshalAs(UnmanagedType.LPStruct)] ref devicemodeW /* DEVMODEW * */ @lpDevMode);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool EnumDisplaySettingsEx( ref IntPtr /* const wchar_t *, LPCWSTR */ @lpszDeviceName,  uint /* DWORD */ @iModeNum, [MarshalAs(UnmanagedType.LPStruct)] ref devicemodeW /* DEVMODEW * */ @lpDevMode,  uint /* DWORD */ @dwFlags);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int EnumProps([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWnd,  ref IntPtr /* int (*)(HWND__ *, const wchar_t *, void *), PROPENUMPROCW */ @lpEnumFunc);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int EnumPropsEx([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWnd,  ref IntPtr /* int (*)(HWND__ *, wchar_t *, void *, unsigned long long), PROPENUMPROCEXW */ @lpEnumFunc,  long /* LPARAM */ @lParam);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool EnumThreadWindows( uint /* DWORD */ @dwThreadId,  ref IntPtr /* int (*)(HWND__ *, long long), WNDENUMPROC */ @lpfn,  long /* LPARAM */ @lParam);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool EnumWindows( ref IntPtr /* int (*)(HWND__ *, long long), WNDENUMPROC */ @lpEnumFunc,  long /* LPARAM */ @lParam);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool EnumWindowStations( ref IntPtr /* int (*)(wchar_t *, long long), WINSTAENUMPROCW */ @lpEnumFunc,  long /* LPARAM */ @lParam);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HWND /* HWND */ FindWindow( ref IntPtr /* const wchar_t *, LPCWSTR */ @lpClassName,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpWindowName);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HWND /* HWND */ FindWindowEx([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWndParent, [MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWndChildAfter,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpszClass,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpszWindow);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool GetAltTabInfo([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hwnd,  int @iItem, [MarshalAs(UnmanagedType.LPStruct)] ref ALTTABINFO /* PALTTABINFO */ @pati, [MarshalAs(UnmanagedType.LPWStr)] ref string /* wchar_t *, LPWSTR */ @pszItemText,  uint /* UINT */ @cchItemText);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool GetClassInfo([MarshalAs(UnmanagedType.Struct)] HINSTANCE /* HINSTANCE */ @hInstance,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpClassName, [MarshalAs(UnmanagedType.LPStruct)] ref WNDCLASSW /* LPWNDCLASSW */ @lpWndClass);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool GetClassInfoEx([MarshalAs(UnmanagedType.Struct)] HINSTANCE /* HINSTANCE */ @hInstance,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpszClass, [MarshalAs(UnmanagedType.LPStruct)] ref WNDCLASSEXW /* LPWNDCLASSEXW */ @lpwcx);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int GetClassName([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWnd, [MarshalAs(UnmanagedType.LPWStr)] ref string /* wchar_t *, LPWSTR */ @lpClassName,  int @nMaxCount);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int GetClipboardFormatName( uint /* UINT */ @format, [MarshalAs(UnmanagedType.LPWStr)] ref string /* wchar_t *, LPWSTR */ @lpszFormatName,  int @cchMaxCount);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int /* LONG */ GetDisplayConfigBufferSizes( uint /* UINT32 */ @flags,  ref IntPtr /* unsigned int *, UINT32 * */ @numPathArrayElements,  ref IntPtr /* unsigned int *, UINT32 * */ @numModeInfoArrayElements);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern uint /* UINT */ GetDlgItemInt([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hDlg,  int @nIDDlgItem,  ref IntPtr /* int *, BOOL * */ @lpTranslated,  bool @bSigned);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern uint /* UINT */ GetDlgItemText([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hDlg,  int @nIDDlgItem, [MarshalAs(UnmanagedType.LPWStr)] ref string /* wchar_t *, LPWSTR */ @lpString,  int @cchMax);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool GetGestureConfig([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hwnd,  uint /* DWORD */ @dwReserved,  uint /* DWORD */ @dwFlags,  ref IntPtr /* unsigned int *, PUINT */ @pcIDs, [MarshalAs(UnmanagedType.LPStruct)] ref GESTURECONFIG /* PGESTURECONFIG */ @pGestureConfig,  uint /* UINT */ @cbSize);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool GetGestureExtraArgs([MarshalAs(UnmanagedType.Struct)] HGESTUREINFO /* HGESTUREINFO */ @hGestureInfo,  uint /* UINT */ @cbExtraArgs,  ref IntPtr /* unsigned char *, PBYTE */ @pExtraArgs);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern uint /* DWORD */ GetGuiResources( ref IntPtr /* void *, HANDLE */ @hProcess,  uint /* DWORD */ @uiFlags);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int GetKeyboardLayoutList( int @nBuff,  ref IntPtr /* HKL__ **, HKL * */ @lpList);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool GetKeyboardLayoutName([MarshalAs(UnmanagedType.LPWStr)] ref string /* wchar_t *, LPWSTR */ @pwszKLID);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool GetKeyboardState( ref IntPtr /* unsigned char *, PBYTE */ @lpKeyState);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int GetKeyboardType( int @nTypeFlag);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int GetKeyNameText( int /* LONG */ @lParam, [MarshalAs(UnmanagedType.LPWStr)] ref string /* wchar_t *, LPWSTR */ @lpString,  int @cchSize);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool GetLayeredWindowAttributes([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hwnd,  ref IntPtr /* unsigned long *, COLORREF * */ @pcrKey,  ref IntPtr /* unsigned char *, BYTE * */ @pbAlpha,  ref IntPtr /* unsigned long *, DWORD * */ @pdwFlags);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int GetMenuString([MarshalAs(UnmanagedType.Struct)] HMENU /* HMENU */ @hMenu,  uint /* UINT */ @uIDItem, [MarshalAs(UnmanagedType.LPWStr)] ref string /* wchar_t *, LPWSTR */ @lpString,  int @cchMax,  uint /* UINT */ @flags);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int GetPriorityClipboardFormat( ref IntPtr /* unsigned int *, UINT * */ @paFormatPriorityList,  int @cFormats);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool GetProcessDefaultLayout( ref IntPtr /* unsigned long *, DWORD * */ @pdwDefaultLayout);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HWINSTA /* HWINSTA */ GetProcessWindowStation();
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern IntPtr /* void *, HANDLE */ GetProp([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWnd,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpString);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern uint /* DWORD */ GetQueueStatus( uint /* UINT */ @flags);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern uint /* UINT */ GetRawInputBuffer([MarshalAs(UnmanagedType.LPStruct)] ref RAWINPUT /* PRAWINPUT */ @pData,  ref IntPtr /* unsigned int *, PUINT */ @pcbSize,  uint /* UINT */ @cbSizeHeader);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern uint /* UINT */ GetRawInputData([MarshalAs(UnmanagedType.Struct)] HRAWINPUT /* HRAWINPUT */ @hRawInput,  uint /* UINT */ @uiCommand,  ref IntPtr /* void *, LPVOID */ @pData,  ref IntPtr /* unsigned int *, PUINT */ @pcbSize,  uint /* UINT */ @cbSizeHeader);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern uint /* UINT */ GetRawInputDeviceInfo( ref IntPtr /* void *, HANDLE */ @hDevice,  uint /* UINT */ @uiCommand,  ref IntPtr /* void *, LPVOID */ @pData,  ref IntPtr /* unsigned int *, PUINT */ @pcbSize);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern uint /* UINT */ GetRawInputDeviceList([MarshalAs(UnmanagedType.LPStruct)] ref RAWINPUTDEVICELIST /* PRAWINPUTDEVICELIST */ @pRawInputDeviceList,  ref IntPtr /* unsigned int *, PUINT */ @puiNumDevices,  uint /* UINT */ @cbSize);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern uint /* UINT */ GetRegisteredRawInputDevices([MarshalAs(UnmanagedType.LPStruct)] ref RAWINPUTDEVICE /* PRAWINPUTDEVICE */ @pRawInputDevices,  ref IntPtr /* unsigned int *, PUINT */ @puiNumDevices,  uint /* UINT */ @cbSize);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool GetScrollRange([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWnd,  int @nBar,  ref IntPtr /* int *, LPINT */ @lpMinPos,  ref IntPtr /* int *, LPINT */ @lpMaxPos);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern uint /* DWORD */ GetTabbedTextExtent([MarshalAs(UnmanagedType.Struct)] HDC /* HDC */ @hdc,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpString,  int @chCount,  int @nTabPositions,  ref IntPtr /* const int *, const INT * */ @lpnTabStopPositions);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool GetUpdatedClipboardFormats( ref IntPtr /* unsigned int *, PUINT */ @lpuiFormats,  uint /* UINT */ @cFormats,  ref IntPtr /* unsigned int *, PUINT */ @pcFormatsOut);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool GetUserObjectInformation( ref IntPtr /* void *, HANDLE */ @hObj,  int @nIndex,  ref IntPtr /* void *, PVOID */ @pvInfo,  uint /* DWORD */ @nLength,  ref IntPtr /* unsigned long *, LPDWORD */ @lpnLengthNeeded);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool GetUserObjectSecurity( ref IntPtr /* void *, HANDLE */ @hObj,  ref IntPtr /* unsigned long *, PSECURITY_INFORMATION */ @pSIRequested,  ref IntPtr /* void *, PSECURITY_DESCRIPTOR */ @pSID,  uint /* DWORD */ @nLength,  ref IntPtr /* unsigned long *, LPDWORD */ @lpnLengthNeeded);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool GetWindowDisplayAffinity([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWnd,  ref IntPtr /* unsigned long *, DWORD * */ @pdwAffinity);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern uint /* UINT */ GetWindowModuleFileName([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hwnd, [MarshalAs(UnmanagedType.LPWStr)] ref string /* wchar_t *, LPWSTR */ @pszFileName,  uint /* UINT */ @cchFileNameMax);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int GetWindowText([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWnd, [MarshalAs(UnmanagedType.LPWStr)] ref string /* wchar_t *, LPWSTR */ @lpString,  int @nMaxCount);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int GetWindowTextLength([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWnd);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern uint /* DWORD */ GetWindowThreadProcessId([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWnd,  ref IntPtr /* unsigned long *, LPDWORD */ @lpdwProcessId);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool GrayString([MarshalAs(UnmanagedType.Struct)] HDC /* HDC */ @hDC, [MarshalAs(UnmanagedType.Struct)] HBRUSH /* HBRUSH */ @hBrush,  ref IntPtr /* int (*)(HDC__ *, long long, int), GRAYSTRINGPROC */ @lpOutputFunc,  long /* LPARAM */ @lpData,  int @nCount,  int @X,  int @Y,  int @nWidth,  int @nHeight);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern uint /* DWORD */ InSendMessageEx( ref IntPtr /* void *, LPVOID */ @lpReserved);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool InsertMenu([MarshalAs(UnmanagedType.Struct)] HMENU /* HMENU */ @hMenu,  uint /* UINT */ @uPosition,  uint /* UINT */ @uFlags,  ulong /* UINT_PTR */ @uIDNewItem,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpNewItem);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int InternalGetWindowText([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWnd, [MarshalAs(UnmanagedType.LPWStr)] ref string /* wchar_t *, LPWSTR */ @pString,  int @cchMaxCount);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool IsTouchWindow([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hwnd,  ref IntPtr /* unsigned long *, PULONG */ @pulFlags);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HACCEL /* HACCEL */ LoadAccelerators([MarshalAs(UnmanagedType.Struct)] HINSTANCE /* HINSTANCE */ @hInstance,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpTableName);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HBITMAP /* HBITMAP */ LoadBitmap([MarshalAs(UnmanagedType.Struct)] HINSTANCE /* HINSTANCE */ @hInstance,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpBitmapName);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HICON /* HCURSOR */ LoadCursor([MarshalAs(UnmanagedType.Struct)] HINSTANCE /* HINSTANCE */ @hInstance,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpCursorName);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HICON /* HCURSOR */ LoadCursorFromFile( ref IntPtr /* const wchar_t *, LPCWSTR */ @lpFileName);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HICON /* HICON */ LoadIcon([MarshalAs(UnmanagedType.Struct)] HINSTANCE /* HINSTANCE */ @hInstance,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpIconName);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern IntPtr /* void *, HANDLE */ LoadImage([MarshalAs(UnmanagedType.Struct)] HINSTANCE /* HINSTANCE */ @hInst,  ref IntPtr /* const wchar_t *, LPCWSTR */ @name,  uint /* UINT */ @type,  int @cx,  int @cy,  uint /* UINT */ @fuLoad);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HKL /* HKL */ LoadKeyboardLayout( ref IntPtr /* const wchar_t *, LPCWSTR */ @pwszKLID,  uint /* UINT */ @Flags);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HMENU /* HMENU */ LoadMenu([MarshalAs(UnmanagedType.Struct)] HINSTANCE /* HINSTANCE */ @hInstance,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpMenuName);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HMENU /* HMENU */ LoadMenuIndirect( ref IntPtr /* const void *, const MENUTEMPLATEW * */ @lpMenuTemplate);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int LoadString([MarshalAs(UnmanagedType.Struct)] HINSTANCE /* HINSTANCE */ @hInstance,  uint /* UINT */ @uID, [MarshalAs(UnmanagedType.LPWStr)] ref string /* wchar_t *, LPWSTR */ @lpBuffer,  int @cchBufferMax);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int LookupIconIdFromDirectory( ref IntPtr /* unsigned char *, PBYTE */ @presbits,  bool @fIcon);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int LookupIconIdFromDirectoryEx( ref IntPtr /* unsigned char *, PBYTE */ @presbits,  bool @fIcon,  int @cxDesired,  int @cyDesired,  uint /* UINT */ @Flags);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int MessageBox([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWnd,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpText,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpCaption,  uint /* UINT */ @uType);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int MessageBoxEx([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWnd,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpText,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpCaption,  uint /* UINT */ @uType,  ushort /* WORD */ @wLanguageId);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool ModifyMenu([MarshalAs(UnmanagedType.Struct)] HMENU /* HMENU */ @hMnu,  uint /* UINT */ @uPosition,  uint /* UINT */ @uFlags,  ulong /* UINT_PTR */ @uIDNewItem,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpNewItem);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern uint /* DWORD */ MsgWaitForMultipleObjects( uint /* DWORD */ @nCount,  ref IntPtr /* void *const *, const HANDLE * */ @pHandles,  bool @fWaitAll,  uint /* DWORD */ @dwMilliseconds,  uint /* DWORD */ @dwWakeMask);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern uint /* DWORD */ MsgWaitForMultipleObjectsEx( uint /* DWORD */ @nCount,  ref IntPtr /* void *const *, const HANDLE * */ @pHandles,  uint /* DWORD */ @dwMilliseconds,  uint /* DWORD */ @dwWakeMask,  uint /* DWORD */ @dwFlags);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool OemToChar( ref IntPtr /* const char *, LPCSTR */ @pSrc, [MarshalAs(UnmanagedType.LPWStr)] ref string /* wchar_t *, LPWSTR */ @pDst);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool OemToCharBuff( ref IntPtr /* const char *, LPCSTR */ @lpszSrc, [MarshalAs(UnmanagedType.LPWStr)] ref string /* wchar_t *, LPWSTR */ @lpszDst,  uint /* DWORD */ @cchDstLength);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HDESK /* HDESK */ OpenDesktop( ref IntPtr /* const wchar_t *, LPCWSTR */ @lpszDesktop,  uint /* DWORD */ @dwFlags,  bool @fInherit,  uint /* ACCESS_MASK */ @dwDesiredAccess);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HWINSTA /* HWINSTA */ OpenWindowStation( ref IntPtr /* const wchar_t *, LPCWSTR */ @lpszWinSta,  bool @fInherit,  uint /* ACCESS_MASK */ @dwDesiredAccess);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern uint /* UINT */ PrivateExtractIcons( ref IntPtr /* const wchar_t *, LPCWSTR */ @szFileName,  int @nIconIndex,  int @cxIcon,  int @cyIcon,  ref IntPtr /* HICON__ **, HICON * */ @phicon,  ref IntPtr /* unsigned int *, UINT * */ @piconid,  uint /* UINT */ @nIcons,  uint /* UINT */ @flags);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int /* LONG */ QueryDisplayConfig( uint /* UINT32 */ @flags,  ref IntPtr /* unsigned int *, UINT32 * */ @numPathArrayElements, [MarshalAs(UnmanagedType.LPStruct)] ref DISPLAYCONFIG_PATH_INFO @pathArray,  ref IntPtr /* unsigned int *, UINT32 * */ @numModeInfoArrayElements, [MarshalAs(UnmanagedType.LPStruct)] ref DISPLAYCONFIG_MODE_INFO @modeInfoArray,  ref IntPtr /* DISPLAYCONFIG_TOPOLOGY_ID *, DISPLAYCONFIG_TOPOLOGY_ID * */ @currentTopologyId);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern uint /* UINT */ RealGetWindowClass([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hwnd, [MarshalAs(UnmanagedType.LPWStr)] ref string /* wchar_t *, LPWSTR */ @ptszClassName,  uint /* UINT */ @cchClassNameMax);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern uint /* UINT */ RegisterClipboardFormat( ref IntPtr /* const wchar_t *, LPCWSTR */ @lpszFormat);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern IntPtr /* void *, HDEVNOTIFY */ RegisterDeviceNotification( ref IntPtr /* void *, HANDLE */ @hRecipient,  ref IntPtr /* void *, LPVOID */ @NotificationFilter,  uint /* DWORD */ @Flags);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern IntPtr /* void *, HPOWERNOTIFY */ RegisterPowerSettingNotification( ref IntPtr /* void *, HANDLE */ @hRecipient, [MarshalAs(UnmanagedType.LPStruct)] ref GUID /* LPCGUID */ @PowerSettingGuid,  uint /* DWORD */ @Flags);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern uint /* UINT */ RegisterWindowMessage( ref IntPtr /* const wchar_t *, LPCWSTR */ @lpString);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern IntPtr /* void *, HANDLE */ RemoveProp([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWnd,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpString);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool SendMessageCallback([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWnd,  uint /* UINT */ @Msg,  ulong /* WPARAM */ @wParam,  long /* LPARAM */ @lParam,  ref IntPtr /* void (*)(HWND__ *, unsigned int, unsigned long long, long long), SENDASYNCPROC */ @lpResultCallBack,  ulong /* ULONG_PTR */ @dwData);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern long /* LRESULT */ SendMessageTimeout([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWnd,  uint /* UINT */ @Msg,  ulong /* WPARAM */ @wParam,  long /* LPARAM */ @lParam,  uint /* UINT */ @fuFlags,  uint /* UINT */ @uTimeout,  ref IntPtr /* unsigned long long *, PDWORD_PTR */ @lpdwResult);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern IntPtr /* void *, HANDLE */ SetClipboardData( uint /* UINT */ @uFormat,  ref IntPtr /* void *, HANDLE */ @hMem);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool SetDlgItemText([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hDlg,  int @nIDDlgItem,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpString);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool SetKeyboardState( ref IntPtr /* unsigned char *, LPBYTE */ @lpKeyState);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool SetProp([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWnd,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpString,  ref IntPtr /* void *, HANDLE */ @hData);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool SetSysColors( int @cElements,  ref IntPtr /* const int *, const INT * */ @lpaElements,  ref IntPtr /* const unsigned long *, const COLORREF * */ @lpaRgbValues);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern ulong /* UINT_PTR */ SetTimer([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWnd,  ulong /* UINT_PTR */ @nIDEvent,  uint /* UINT */ @uElapse,  ref IntPtr /* void (*)(HWND__ *, unsigned int, unsigned long long, unsigned long), TIMERPROC */ @lpTimerFunc);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool SetUserObjectInformation( ref IntPtr /* void *, HANDLE */ @hObj,  int @nIndex,  ref IntPtr /* void *, PVOID */ @pvInfo,  uint /* DWORD */ @nLength);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool SetUserObjectSecurity( ref IntPtr /* void *, HANDLE */ @hObj,  ref IntPtr /* unsigned long *, PSECURITY_INFORMATION */ @pSIRequested,  ref IntPtr /* void *, PSECURITY_DESCRIPTOR */ @pSID);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HHOOK /* HHOOK */ SetWindowsHook( int @nFilterType,  ref IntPtr /* long long (*)(int, unsigned long long, long long), HOOKPROC */ @pfnFilterProc);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern HHOOK /* HHOOK */ SetWindowsHookEx( int @idHook,  ref IntPtr /* long long (*)(int, unsigned long long, long long), HOOKPROC */ @lpfn, [MarshalAs(UnmanagedType.Struct)] HINSTANCE /* HINSTANCE */ @hmod,  uint /* DWORD */ @dwThreadId);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool SetWindowText([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWnd,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpString);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool ShutdownBlockReasonCreate([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWnd,  ref IntPtr /* const wchar_t *, LPCWSTR */ @pwszReason);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool ShutdownBlockReasonQuery([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWnd, [MarshalAs(UnmanagedType.LPWStr)] ref string /* wchar_t *, LPWSTR */ @pwszBuff,  ref IntPtr /* unsigned long *, DWORD * */ @pcchBuff);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool SystemParametersInfo( uint /* UINT */ @uiAction,  uint /* UINT */ @uiParam,  ref IntPtr /* void *, PVOID */ @pvParam,  uint /* UINT */ @fWinIni);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int /* LONG */ TabbedTextOut([MarshalAs(UnmanagedType.Struct)] HDC /* HDC */ @hdc,  int @x,  int @y,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpString,  int @chCount,  int @nTabPositions,  ref IntPtr /* const int *, const INT * */ @lpnTabStopPositions,  int @nTabOrigin);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern ushort /* WORD */ TileWindows([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hwndParent,  uint /* UINT */ @wHow, [MarshalAs(UnmanagedType.LPStruct)] ref RECT /* const RECT * */ @lpRect,  uint /* UINT */ @cKids,  ref IntPtr /* HWND__ *const *, const HWND * */ @lpKids);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int ToAscii( uint /* UINT */ @uVirtKey,  uint /* UINT */ @uScanCode,  ref IntPtr /* const unsigned char *, const BYTE * */ @lpKeyState,  ref IntPtr /* unsigned short *, LPWORD */ @lpChar,  uint /* UINT */ @uFlags);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int ToAsciiEx( uint /* UINT */ @uVirtKey,  uint /* UINT */ @uScanCode,  ref IntPtr /* const unsigned char *, const BYTE * */ @lpKeyState,  ref IntPtr /* unsigned short *, LPWORD */ @lpChar,  uint /* UINT */ @uFlags, [MarshalAs(UnmanagedType.Struct)] HKL /* HKL */ @dwhkl);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int ToUnicode( uint /* UINT */ @wVirtKey,  uint /* UINT */ @wScanCode,  ref IntPtr /* const unsigned char *, const BYTE * */ @lpKeyState, [MarshalAs(UnmanagedType.LPWStr)] ref string /* wchar_t *, LPWSTR */ @pwszBuff,  int @cchBuff,  uint /* UINT */ @wFlags);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern int ToUnicodeEx( uint /* UINT */ @wVirtKey,  uint /* UINT */ @wScanCode,  ref IntPtr /* const unsigned char *, const BYTE * */ @lpKeyState, [MarshalAs(UnmanagedType.LPWStr)] ref string /* wchar_t *, LPWSTR */ @pwszBuff,  int @cchBuff,  uint /* UINT */ @wFlags, [MarshalAs(UnmanagedType.Struct)] HKL /* HKL */ @dwhkl);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool UnhookWindowsHook( int @nCode,  ref IntPtr /* long long (*)(int, unsigned long long, long long), HOOKPROC */ @pfnFilterProc);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool UnpackDDElParam( uint /* UINT */ @msg,  long /* LPARAM */ @lParam,  ref IntPtr /* unsigned long long *, PUINT_PTR */ @puiLo,  ref IntPtr /* unsigned long long *, PUINT_PTR */ @puiHi);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool UnregisterClass( ref IntPtr /* const wchar_t *, LPCWSTR */ @lpClassName, [MarshalAs(UnmanagedType.Struct)] HINSTANCE /* HINSTANCE */ @hInstance);
    
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool UnregisterDeviceNotification( ref IntPtr /* void *, HDEVNOTIFY */ @Handle);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool UnregisterPowerSettingNotification( ref IntPtr /* void *, HPOWERNOTIFY */ @Handle);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool UserHandleGrantAccess( ref IntPtr /* void *, HANDLE */ @hUserHandle,  ref IntPtr /* void *, HANDLE */ @hJob,  bool @bGrant);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    public static extern uint /* DWORD */ WaitForInputIdle( ref IntPtr /* void *, HANDLE */ @hProcess,  uint /* DWORD */ @dwMilliseconds);
    ...
    [DllImport("User32.dll", CharSet = CharSet.Auto, SetLastError = true)]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool WinHelp([MarshalAs(UnmanagedType.Struct)] HWND /* HWND */ @hWndMain,  ref IntPtr /* const wchar_t *, LPCWSTR */ @lpszHelp,  uint /* UINT */ @uCommand,  ulong /* ULONG_PTR */ @dwData);
    }
}
